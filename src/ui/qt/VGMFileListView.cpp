...
VGMFileListViewModel::VGMFileListViewModel(QObject *parent)
  ...
  connect(&qtVGMRoot, SIGNAL(UI_RemovedVGMFile()), this,
          SLOT(changedVGMFiles()));
}
...
VGMFileListView::VGMFileListView(QWidget *parent) : QListView(parent) {
  ...
  //    connect(this,
  //    SIGNAL(clicked(QModelIndex)),this,SLOT(myItemSelected(QModelIndex)));
  connect(this, SIGNAL(doubleClicked(QModelIndex)), this,
          SLOT(doubleClickedSlot(QModelIndex)));
}
