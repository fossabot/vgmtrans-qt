...
RawFileListViewModel::RawFileListViewModel(QObject *parent)
  ...
  QObject::connect(&qtVGMRoot, SIGNAL(UI_AddedRawFile()), this,
                   SLOT(changedRawFiles()));
  QObject::connect(&qtVGMRoot, SIGNAL(UI_RemovedRawFile()), this,
                   SLOT(changedRawFiles()));
}
...
QVariant RawFileListViewModel::headerData(int section,
