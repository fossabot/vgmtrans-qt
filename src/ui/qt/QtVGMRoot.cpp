...
void QtVGMRoot::UI_AddRawFile(RawFile* newFile) { this->UI_AddedRawFile(); }
...
void QtVGMRoot::UI_AddVGMFile(VGMFile* theFile) { this->UI_AddedVGMFile(); }
...
void QtVGMRoot::UI_AddVGMColl(VGMColl* theColl) { this->UI_AddedVGMColl(); }
...
void QtVGMRoot::UI_AddItem(VGMItem* item, VGMItem* parent,
                           const std::wstring& itemName, void* UI_specific) {}

void QtVGMRoot::UI_AddItemSet(VGMFile* file, std::vector<ItemSet>* itemset) {}

std::wstring QtVGMRoot::UI_GetOpenFilePath(
    const std::wstring& suggestedFilename, const std::wstring& extension) {
  std::wstring path = L"Placeholder";
  return path;
}

std::wstring QtVGMRoot::UI_GetSaveFilePath(
    const std::wstring& suggestedFilename, const std::wstring& extension) {
  std::wstring path = L"Placeholder";
  return path;
}
