...
MusicPlayer::MusicPlayer() {
  ...
  //        fluid_synth_set_reverb(synth, 0.5, 0.8, FLUID_REVERB_DEFAULT_WIDTH,
  //        0.5);
  ...
  //    fluid_player_set_playback_callback(this->player, &midi_event_callback,
  //    this->synth);
}
...
int midi_event_callback(void* data, fluid_midi_event_t* event) {
  int track_num =
      (vgmtrans_fluid_midi_event_get_track((vgmtrans_fluid_midi_event_t*)event))
          ->num;
