...
class MidiTrack {
 public:
  ...
  void AddNoteByDur_TriAce(uint8_t channel, int8_t key, int8_t vel,
                           uint32_t duration);
  void InsertNoteByDur(uint8_t channel, int8_t key, int8_t vel,
  ...
  void AddControllerEvent(uint8_t channel, uint8_t controllerNum,
                          uint8_t theDataByte);  // This function should be used
                                                 // for only redirection output
                                                 // of MIDI-like formats
  void InsertControllerEvent(uint8_t channel, uint8_t controllerNum,
                             uint8_t theDataByte,
                             uint32_t absTime);  // This function should be used
                                                 // for only redirection output
                                                 // of MIDI-like formats
  // void AddVolMarker(uint8_t channel, uint8_t vol, int8_t priority =
  // PRIORITY_HIGHER);  void InsertVolMarker(uint8_t channel, uint8_t vol,
  // uint32_t absTime, int8_t priority = PRIORITY_HIGHER);
  void AddVol(uint8_t channel,
              uint8_t vol /*, int8_t priority = PRIORITY_MIDDLE*/);
  void InsertVol(uint8_t channel, uint8_t vol,
                 uint32_t absTime /*, int8_t priority = PRIORITY_MIDDLE*/);
  void AddMasterVol(uint8_t channel,
                    uint8_t mastVol /*, int8_t priority = PRIORITY_HIGHER*/);
  void InsertMasterVol(
      uint8_t channel, uint8_t mastVol,
      uint32_t absTime /*, int8_t priority = PRIORITY_HIGHER*/);
  ...
  void InsertPitchBendRange(uint8_t channel, uint8_t semitones, uint8_t cents,
                            uint32_t absTime);
  void AddFineTuning(uint8_t channel, uint8_t msb, uint8_t lsb);
  void InsertFineTuning(uint8_t channel, uint8_t msb, uint8_t lsb,
                        uint32_t absTime);
  ...
  void InsertCoarseTuning(uint8_t channel, uint8_t msb, uint8_t lsb,
                          uint32_t absTime);
  ...
  void InsertModulationDepthRange(uint8_t channel, uint8_t msb, uint8_t lsb,
                                  uint32_t absTime);
  void AddModulationDepthRange(uint8_t channel, double semitones);
  void InsertModulationDepthRange(uint8_t channel, double semitones,
                                  uint32_t absTime);
  ...
  void InsertTimeSig(uint8_t numer, uint8_t denom, uint8_t ticksPerQuarter,
                     uint32_t absTime);
  ...
  void AddMarker(uint8_t channel, const std::string &markername,
...
class MidiFile {
 ...
 public:
  ...
  MidiTrack globalTrack;  // events in the globalTrack will be copied into every
                          // other track
...
class MidiEvent {
 public:
  MidiEvent(MidiTrack *thePrntTrk, uint32_t absoluteTime, uint8_t theChannel,
            int8_t thePriority);
  ...
  uint32_t WriteSysexEvent(std::vector<uint8_t> &buf, uint32_t time,
                           uint8_t *data, size_t dataSize);
  uint32_t WriteMetaEvent(std::vector<uint8_t> &buf, uint32_t time,
                          uint8_t metaType, uint8_t *data, size_t dataSize);
  uint32_t WriteMetaTextEvent(std::vector<uint8_t> &buf, uint32_t time,
                              uint8_t metaType, std::wstring wstr);
  ...
  int8_t priority;
  uint8_t channel;
  uint32_t AbsTime;  // absolute time... the number of ticks from the very
                     // beginning of the sequence at which this event occurs
};
...
class NoteEvent : public MidiEvent {
 public:
  NoteEvent(MidiTrack *prntTrk, uint8_t channel, uint32_t absoluteTime,
            bool bnoteDown, uint8_t theKey, uint8_t theVel = 64);
...
//{
// public:
//	DurNoteEvent(MidiTrack* prntTrk, uint8_t channel, uint32_t absoluteTime,
//uint8_t theKey, uint8_t theVel, uint32_t theDur);
...
class VolumeEvent : public ControllerEvent {
 public:
  VolumeEvent(MidiTrack *prntTrk, uint8_t channel, uint32_t absoluteTime,
              uint8_t volume)
      : ControllerEvent(prntTrk, channel, absoluteTime, 7, volume,
                        PRIORITY_MIDDLE) {}
...
class ExpressionEvent : public ControllerEvent {
 public:
  ExpressionEvent(MidiTrack *prntTrk, uint8_t channel, uint32_t absoluteTime,
                  uint8_t expression)
      : ControllerEvent(prntTrk, channel, absoluteTime, 11, expression,
                        PRIORITY_MIDDLE) {}
...
class SustainEvent : public ControllerEvent {
 public:
  SustainEvent(MidiTrack *prntTrk, uint8_t channel, uint32_t absoluteTime,
               uint8_t depth)
      : ControllerEvent(prntTrk, channel, absoluteTime, 64, depth,
                        PRIORITY_MIDDLE) {}
...
class PortamentoEvent : public ControllerEvent {
 public:
  PortamentoEvent(MidiTrack *prntTrk, uint8_t channel, uint32_t absoluteTime,
                  uint8_t bOn)
      : ControllerEvent(prntTrk, channel, absoluteTime, 65, (bOn) ? 0x7F : 0,
                        PRIORITY_MIDDLE) {}
...
class PortamentoTimeEvent : public ControllerEvent {
 public:
  PortamentoTimeEvent(MidiTrack *prntTrk, uint8_t channel,
                      uint32_t absoluteTime, uint8_t time)
      : ControllerEvent(prntTrk, channel, absoluteTime, 5, time,
                        PRIORITY_MIDDLE) {}
...
class PanEvent : public ControllerEvent {
 public:
  PanEvent(MidiTrack *prntTrk, uint8_t channel, uint32_t absoluteTime,
           uint8_t pan)
      : ControllerEvent(prntTrk, channel, absoluteTime, 10, pan,
                        PRIORITY_MIDDLE) {}
...
class ModulationEvent : public ControllerEvent {
 public:
  ModulationEvent(MidiTrack *prntTrk, uint8_t channel, uint32_t absoluteTime,
                  uint8_t depth)
      : ControllerEvent(prntTrk, channel, absoluteTime, 1, depth,
                        PRIORITY_MIDDLE) {}
...
class BreathEvent : public ControllerEvent {
 public:
  BreathEvent(MidiTrack *prntTrk, uint8_t channel, uint32_t absoluteTime,
              uint8_t depth)
      : ControllerEvent(prntTrk, channel, absoluteTime, 2, depth,
                        PRIORITY_MIDDLE) {}
...
class BankSelectEvent : public ControllerEvent {
 public:
  BankSelectEvent(MidiTrack *prntTrk, uint8_t channel, uint32_t absoluteTime,
                  uint8_t bank)
      : ControllerEvent(prntTrk, channel, absoluteTime, 0, bank,
                        PRIORITY_HIGH) {}
...
class BankSelectFineEvent : public ControllerEvent {
 public:
  BankSelectFineEvent(MidiTrack *prntTrk, uint8_t channel,
                      uint32_t absoluteTime, uint8_t bank)
      : ControllerEvent(prntTrk, channel, absoluteTime, 32, bank,
                        PRIORITY_HIGH) {}
...
{
public:
        VolEvent(MidiTrack* prntTrk, uint8_t channel, uint32_t absoluteTime,
uint8_t theVol, int8_t thePriority = PRIORITY_MIDDLE); virtual VolEvent*
MakeCopy();
        //virtual uint32_t WriteEvent(std::vector<uint8_t> & buf, uint32_t
time);
...
{
public:
        VolMarkerEvent(MidiTrack* prntTrk, uint8_t channel, uint32_t
absoluteTime, uint8_t theVol, int8_t thePriority = PRIORITY_HIGHER); virtual
VolMarkerEvent* MakeCopy(); virtual uint32_t WriteEvent(std::vector<uint8_t> &
buf, uint32_t time);
...
class MastVolEvent : public MidiEvent {
 public:
  MastVolEvent(MidiTrack *prntTrk, uint8_t channel, uint32_t absoluteTime,
               uint8_t mastVol);
...
{
public:
        ExpressionEvent(MidiTrack* prntTrk, uint8_t channel, uint32_t
absoluteTime, uint8_t expression, int8_t thePriority = PRIORITY_HIGHER); virtual
ExpressionEvent* MakeCopy(); virtual uint32_t WriteEvent(std::vector<uint8_t> &
buf, uint32_t time);
...
class MonoEvent : public ControllerEvent {
 public:
  MonoEvent(MidiTrack *prntTrk, uint8_t channel, uint32_t absoluteTime)
      : ControllerEvent(prntTrk, channel, absoluteTime, 126, 127,
                        PRIORITY_MIDDLE) {}
...
class ProgChangeEvent : public MidiEvent {
 public:
  ProgChangeEvent(MidiTrack *prntTrk, uint8_t channel, uint32_t absoluteTime,
                  uint8_t progNum);
...
class PitchBendEvent : public MidiEvent {
 public:
  PitchBendEvent(MidiTrack *prntTrk, uint8_t channel, uint32_t absoluteTime,
                 int16_t bend);
...
class TimeSigEvent : public MidiEvent {
 public:
  TimeSigEvent(MidiTrack *prntTrk, uint32_t absoluteTime, uint8_t numerator,
...
class TextEvent : public MidiEvent {
 public:
  TextEvent(MidiTrack *prntTrk, uint32_t absoluteTime,
...
class SeqNameEvent : public MidiEvent {
 public:
  SeqNameEvent(MidiTrack *prntTrk, uint32_t absoluteTime,
               const std::wstring &wstr);
  virtual MidiEventType GetEventType() { return MIDIEVENT_TEXT; }
  virtual uint32_t WriteEvent(std::vector<uint8_t> &buf, uint32_t time);
...
class TrackNameEvent : public MidiEvent {
 public:
  TrackNameEvent(MidiTrack *prntTrk, uint32_t absoluteTime,
                 const std::wstring &wstr);
  virtual MidiEventType GetEventType() { return MIDIEVENT_TEXT; }
  virtual uint32_t WriteEvent(std::vector<uint8_t> &buf, uint32_t time);
...
// SPECIAL EVENTS THAT AFFECT OTHER MIDI EVENTS RATHER THAN DIRECTLY OUTPUT TO
// THE FILE
class GlobalTransposeEvent : public MidiEvent {
 public:
  GlobalTransposeEvent(MidiTrack *prntTrk, uint32_t absoluteTime,
                       int8_t semitones);
...
class MarkerEvent : public MidiEvent {
 public:
  MarkerEvent(MidiTrack *prntTrk, uint8_t channel, uint32_t absoluteTime,
              const std::string &name, uint8_t databyte1, uint8_t databyte2,
              int8_t thePriority = PRIORITY_MIDDLE)
