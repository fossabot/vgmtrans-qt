...
BytePattern FalcomSnesScanner::ptnSetDIR("\xe8\x1b\x8f\x5d\xf2\xc4\xf3",
                                         "x?xxxxx", 7);

//; Ys V: Ushinawareta Suna no Miyako Kefin SPC
// 1446: cd 00     mov   x,#$00
// 1448: 75 7c 0b  cmp   a,$0b7c+x         ; read instrument-SRCN lookup table
// 144b: f0 03     beq   $1450             ; break if the instrument found
// (x=SRCN)  144d: 3d        inc   x  144e: 2f f8     bra   $1448  1450: 8d 05
// mov   y,#$05  1452: cf        mul   ya  1453: fd        mov   y,a  1454: 7d
// mov   a,x  1455: f8 aa     mov   x,$aa  1457: d5 28 02  mov   $0228+x,a
// ; SRCN  145a: f6 95 11  mov   a,$1195+y
...
void FalcomSnesScanner::SearchForFalcomSnesFromARAM(RawFile *file) {
  ...
  FalcomSnesInstrSet *newInstrSet = new FalcomSnesInstrSet(
      file, version, addrInstrTable, addrSampToInstrTable, spcDirAddr,
