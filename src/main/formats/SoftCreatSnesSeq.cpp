...
SoftCreatSnesSeq::SoftCreatSnesSeq(RawFile *file, SoftCreatSnesVersion ver,
...
void SoftCreatSnesSeq::ResetVars(void) { VGMSeq::ResetVars(); }
...
bool SoftCreatSnesSeq::GetHeaderInfo(void) {
  ...
  for (uint8_t trackIndex = 0; trackIndex < MAX_TRACKS; trackIndex++) {
    ...
    uint16_t addrTrackStart =
        GetByte(addrTrackLowPtr) | (GetByte(addrTrackHighPtr) << 8);
...
bool SoftCreatSnesSeq::GetTrackPointers(void) { return true; }
...
SoftCreatSnesTrack::SoftCreatSnesTrack(SoftCreatSnesSeq *parentFile,
...
void SoftCreatSnesTrack::ResetVars(void) { SeqTrack::ResetVars(); }
