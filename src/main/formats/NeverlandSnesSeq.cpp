...
void NeverlandSnesSeq::ResetVars(void) { VGMSeq::ResetVars(); }
...
bool NeverlandSnesSeq::GetHeaderInfo(void) {
  ...
  for (uint8_t trackIndex = 0; trackIndex < MAX_TRACKS; trackIndex++) {
    ...
    if (trackSign != 0xff) {
      ...
      NeverlandSnesTrack *track =
          new NeverlandSnesTrack(this, sectionListAddress);
...
bool NeverlandSnesSeq::GetTrackPointers(void) { return true; }
...
void NeverlandSnesTrack::ResetVars(void) { SeqTrack::ResetVars(); }
