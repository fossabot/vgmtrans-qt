...
enum NinSnesVersion {
  ...
  NINSNES_STANDARD,  // Common version with voice commands $e0-fa (e.g. Yoshi
                     // Island)
  ...
  NINSNES_KONAMI,  // Old Konami games (e.g. Gradius III, Castlevania IV, Legend
  ...
  NINSNES_TOSE,         // TOSE games (e.g. Yoshi's Safari, Dragon Ball Z: Super
                        // Butouden 2)
