...
HudsonSnesInstrSet::HudsonSnesInstrSet(RawFile *file, HudsonSnesVersion ver,
...
bool HudsonSnesInstrSet::GetHeaderInfo() { return true; }
...
bool HudsonSnesInstrSet::GetInstrPointers() {
  ...
  SNESSampColl *newSampColl = new SNESSampColl(
      HudsonSnesFormat::name, this->rawfile, spcDirAddr, usedSRCNs);
...
HudsonSnesInstr::HudsonSnesInstr(VGMInstrSet *instrSet, HudsonSnesVersion ver,
                                 uint32_t offset, uint8_t instrNum,
                                 uint32_t spcDirAddr,
                                 uint32_t addrSampTuningTable,
                                 const std::wstring &name)
...
bool HudsonSnesInstr::LoadInstr() {
  ...
  HudsonSnesRgn *rgn =
      new HudsonSnesRgn(this, version, dwOffset, spcDirAddr, ofsTuningEnt);
...
HudsonSnesRgn::HudsonSnesRgn(HudsonSnesInstr *instr, HudsonSnesVersion ver,
...
bool HudsonSnesRgn::LoadRgn() { return true; }
